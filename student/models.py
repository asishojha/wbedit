...
class Student(models.Model):
    ...
    f_name = models.CharField(
        max_length=40, verbose_name="Father's Name", null=True, blank=True
    )
    m_name = models.CharField(
        max_length=40, verbose_name="Mother's Name", null=True, blank=True
    )
    g_indicator = models.CharField(max_length=1, null=True, blank=True)
    g_name = models.CharField(
        max_length=40, null=True, verbose_name="Guardian's Name", blank=True
    )
    ...
    dob = models.CharField(
        max_length=10, verbose_name="Date of Birth", null=True, blank=True
    )
    ...
    opt = models.CharField(
        max_length=2, null=True, blank=True, verbose_name="Optional Elective"
    )
    ...
    def get_absolute_url(self):
        return reverse("student:student", kwargs={"serial": self.serial})
